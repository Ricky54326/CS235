...
public class ClientPlus {
	...
	private lab3p2.DataPlus dataIn;
	private lab3p2.DataPlus dataOut;
	...
	public void readData(String inf) throws Exception {
		...
		dataIn = new lab3p2.DataPlus( integerIn, stringIn, floatIn, doubleIn);
	...
	public void modifyInputData() {
		dataOut = new lab3p2.DataPlus( dataIn.getID() + 10, 
				dataIn.getName() + "Language", dataIn.getScore() + 100.0f,
				dataIn.getGradePointAverage() + 0.5);
	}
	...
	public void writeData(String of) {
		...
		outf.println( "" + dataOut.getID() + "\t" + dataOut.getName() + "\t" + dataOut.getScore() +  "\t" + dataOut.getGradePointAverage());
